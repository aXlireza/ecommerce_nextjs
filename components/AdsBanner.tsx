...
const AdsBanner: React.FC<AdsBanner> = ({ title, link, description, imgUrl, alt }) => {
	return (
		<Link href={link} className='flex flex-row rounded-2xl overflow-hidden dark:border-slate-600 border-slate-200 border-2'>
      <div className='flex flex-col p-5 py-10'>
        ...
        <h5 className='text-lg text-black dark:text-white'>{description}</h5>
